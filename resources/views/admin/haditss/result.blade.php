      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
                ...
                <div id="rumus2" style="display: none;">
                ...
                <div id="rumus" style="display: none;">
                    ...
                    <hr>
                    <br>
                    <table id="example1" class="table table-bordered table-striped" style="border-style: 1px solid">
                      
                      <tr>
                        <th colspan="2">Cosine</th><!-- sesuai jumlah ayat -->
                      </tr>                      
          ...
          <table id="example1" class="table table-bordered table-striped" >
                      ...
                      <tr>
                         ...
                         @foreach($ranking_cosine as $ayat => $rank_cos)
                         @if(@$cosine[$ayat]!=0)
                          <tr>
                            <th>@if(@$cosine[$ayat]!=0){{$cosine[$ayat]}}@endif</th>
                            <td>{{$haditss[$ayat]->nomor}}</td>
                            <td>{{ $haditss[$ayat]->kitab }}</td>
                            <td>{{ $haditss[$ayat]->bab }}</td>
                            <td>{{ $haditss[$ayat]->isi }}</td>
                          </tr>
                          @endif
                         @endforeach
          </table> 
